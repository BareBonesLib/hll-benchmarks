...
//            this.registers[i] = (
//                    ((array[i * 4] & 0xFFL) << 56) |
//                            ((array[i * 4 + 1] & 0xFFL) << 48) |
//                            ((array[i * 4 + 2] & 0xFFL) << 40) |
//                            ((array[i * 4 + 3] & 0xFFL) << 32) |
//                            ((array[i * 4 + 4] & 0xFFL) << 24) |
//                            ((array[i * 4 + 5] & 0xFFL) << 16) |
//                            ((array[i * 4 + 6] & 0xFFL) << 8) |
//                            (array[i * 4 + 7] & 0xFFL)
//            );
//        }
...
//                word |= (Long.compareUnsigned(thisVal, thatVal) > 0 ? thatVal : thisVal);
...
//    }
//
//    public static HLL2 deserialize(byte[] array) {
//        return new HLL2(array);
//    }
//
//    void debugInfo() {
